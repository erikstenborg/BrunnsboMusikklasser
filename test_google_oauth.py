...
def test_google_oauth_config():
    ...
    print("2. Select your NEW OAuth 2.0 Client ID (the one you just reset)")
    print("3. In 'Authorized redirect URIs', add EXACTLY these URLs:")
    print(f"   {callback_url}")
    print("   https://brunnsbomusikklasser.replit.app/auth/google_callback")
    print("4. Save changes")
    print("5. Wait 1-2 minutes for Google to update")
    print()
    print("⚠️  CRITICAL:")
    print("   - Use the NEW OAuth Client ID credentials (after reset)")
    print("   - Both Client ID and Secret must match the same OAuth app")
    ...
    print("   2. Test the Google login on your app")
    print("   3. If it works, you're all set!")
